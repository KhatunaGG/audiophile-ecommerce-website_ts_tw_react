                ...
                <div className="flex flex-col items-center gap-[48px]  md:items-start md:gap-8 lg:w-full">
                    <div className="w-full flex flex-col items-center justify-center gap-[48px]  md:justify-start lg:flex-row lg:justify-between">
                        <svg
                            ...
                            <path
                                className='fill-current text-white hover:text-[#D87D4A]'
                        ...
                        <ul className="nav list-none flex flex-col gap-[16px] cursor-pointer items-center justify-center uppercase text-[13px] tracking-[2px] leading-[1.93] font-bold md:flex-row md:gap-[34px] ">
