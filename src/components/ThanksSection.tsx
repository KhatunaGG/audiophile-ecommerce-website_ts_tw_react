...
const ThanksSection = ({ summeryCartItem }: ThanksSectionPropsType) => {
    ...
    return (
        <div className="overlay w-screen   h-full bg-[#00000071] pb-[1000px] md:pb-0 absolute z-30 top-[90px] left-0 right-0 flex flex-col items-center justify-cente lg:pt-[79px] lg:pb-[170px]">
